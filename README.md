...
- Sign up using Credient email/password & Oauth
- Supply the firm with liquidity
- Initiate the process to withdraw lent money
- Apply for a loan by providing collateral, such as property, vehicles, or equity.
- Repay their loan
- View their outsanding debt
- Check their current earned fees

## Requirements:
- Develop a frontend that allows users to interact with the app 
- Develop a backend thats handles users requests.

Stack: 
- React/NextJS, Typescript, Turborepo
